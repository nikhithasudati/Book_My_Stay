      ...
      <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
        {addedPhotos.length > 0 &&
          addedPhotos.map((link) => (
            <div key={link} className="h-32 relative"> {/* Added 'relative' class for positioning */}
              <img
        ...
        <label className="h-32 cursor-pointer flex gap-1 items-center justify-center border bg-transparent rounded-2xl p-2 text-3xl text-gray-600">
          <input
            type="file"
            multiple
            className="hidden"
