                ...
                <div> 
                    <form >
                        ...
                        <div className='flex gap-2'>
                             <input type = "text" value = {addedPhotos} onChange = {ev => setAddedPhotos(ev.target.value)} placeholder='add using a link' />
                                <button onClick = {addPhotoByLink} className='bg-gray-200 px-4 rounded-2xl'> Add photo</button>
                        </div>
                        <div className='mt-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6'>
                            <button className='flex gap-1 justify-center border bg-transparent rounded-2xl p-8 text-3xl text-gray-600'>
